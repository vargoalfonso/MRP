...
func (s *service) GetByID(ctx context.Context, id string) (*models.Role, error) {
...
func (s *service) Update(ctx context.Context, id string, req models.UpdateRoleRequest) (*models.Role, error) {
